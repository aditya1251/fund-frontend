...
export default function TradeLicenseLanding() {
  const whyTradeLicenseCrucial = [
    ...
    },
    {
      ...
      title: "Legitimacy",
      description: "It shows that your business is legitimate and has the legal permission to operate.",
  ...
  const serviceSteps = [
    {
      ...
      description: "Helping you understand which type of license your business needs based on your business activity.",
    },
    {
    ...
    },
    {
      ...
      description: "Filling out the application form correctly and submitting it to the local government body.",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Follow-up & Support",
      description: "Following up on your application to make sure you get your license quickly.",
    },
  ]
  ...
  const stats = [
    { number: "25K+", label: "Licenses Obtained", icon: <Store className="h-5 w-5" /> },
    { number: "30 Days", label: "Average Processing", icon: <Clock className="h-5 w-5" /> },
    { number: "98%", label: "Success Rate", icon: <CheckCircle className="h-5 w-5" /> },
    { number: "500+", label: "Cities Covered", icon: <MapPin className="h-5 w-5" /> },
  ]
  ...
  const requiredDocuments = [
    ...
    },
    {
      ...
      description: "Shop Act registration, GST registration, or incorporation certificate",
      icon: <Building2 className="h-4 w-4" />,
    },
    {
      document: "NOC Certificates",
      description: "No Objection Certificates from fire, health, and pollution departments",
  ...
  const renewalProcess = [
    { step: "Renewal Notice", timeline: "30 days before expiry", action: "Submit renewal application" },
    { step: "Document Update", timeline: "15 days before expiry", action: "Update changed information" },
    { step: "Fee Payment", timeline: "Before expiry date", action: "Pay renewal fees" },
    { step: "License Renewal", timeline: "On approval", action: "Receive renewed license" },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <section className="bg-gradient-to-br from-[#FFF0C3] via-[#FFFFFF] to-[#FFF0C3] py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#1E1E1E] mb-4">Trade License</h1>
            ...
            <p className="text-lg sm:text-xl text-[#1E1E1E] max-w-4xl mx-auto mb-10 leading-relaxed">
              A trade license is a permission given by the local government (like a municipal corporation) to run a
              specific business in a particular area. It ensures that your business follows the rules and safety
              standards of that area, like health, safety, and fire regulations.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-12 text-center">What is a Trade License?</h2>
              ...
              <Card className="border-[#FFF0C3] shadow-lg">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-[#1E1E1E]">Local Business Authorization</h3>
                  </div>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed mb-6">
                    A trade license is official permission from local government authorities to operate a business in a
                    specific location, ensuring compliance with local regulations and safety standards.
                  </p>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed">
                    This license validates that your business meets health, safety, fire, and environmental regulations
                    required by the municipal corporation or local governing body.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">Types of Trade Licenses</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Different business activities require specific types of trade licenses with varying requirements, fees, and
            processing times.
          </p>
                ...
                <CardContent className="p-8">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-[#1E1E1E] mb-2">{license.type}</h3>
                      <p className="text-[#1E1E1E] opacity-80 mb-4">{license.description}</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm font-medium text-[#1E1E1E] mb-1">Validity</p>
                      <Badge className="bg-[#F7C430] text-[#1E1E1E] text-xs">{license.validity}</Badge>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-[#1E1E1E] mb-1">Processing</p>
                      <Badge className="bg-[#1E1E1E] text-[#FFFFFF] text-xs">{license.processing}</Badge>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-[#1E1E1E] mb-1">Fees</p>
                      <span className="text-sm text-[#1E1E1E]">{license.fees}</span>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-[#1E1E1E] mb-1">Authority</p>
                      <span className="text-xs text-[#1E1E1E] opacity-80">{license.authority}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">Compliance Requirements</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Trade licenses require compliance with various local regulations and obtaining clearances from multiple
            departments.
          </p>
              ...
              <Card key={index} className="border-[#FFF0C3] hover:border-[#F7C430] transition-colors">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#1E1E1E] mb-2">{requirement.requirement}</h3>
                      <p className="text-[#1E1E1E] opacity-80 mb-2">{requirement.description}</p>
                      <Badge className="bg-[#1E1E1E] text-[#FFFFFF] text-xs">{requirement.authority}</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Operating without a trade license or violating license conditions can result in severe penalties and
            business closure.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Our streamlined process ensures your trade license application is completed efficiently with all required
            compliance.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Trade license ensures legal compliance, establishes business legitimacy, and protects your business from
            disputes while enabling smooth operations.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            We make the trade license process easy for you, handling all complexities to ensure quick approval and
            complete compliance.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">Who Needs Trade License?</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Anyone who wants to start a business like a shop, restaurant, factory, or commercial establishment in a
            ...
            {businessTypes.map((business, index) => (
              <Card key={index} className="bg-[#FFFFFF] border-none shadow-lg text-center">
                <CardContent className="p-6">
                  ...
                  <Badge className="bg-[#F7C430] text-[#1E1E1E] text-xs">{business.licenseType}</Badge>
                </CardContent>
              </Card>
            ))}
          </div>
