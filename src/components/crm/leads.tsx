          ...
          return (
            <div
              ...
              <div className="bg-gradient-to-br from-[#121212] to-[#353535] px-3 py-2 md:px-4 md:py-3 rounded-b-lg flex items-end justify-between">
                ...
                <Link
                  href="/#plans"
                  className="bg-[#f5d949] text-black text-[10px] md:text-xs px-2 py-1 md:px-2.5 md:py-1 rounded-md flex items-center gap-1 shadow-md">
                  <span>UPGRADE</span>
        ...
        return (
          <div
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                href={card.link}
                className="text-xs md:text-sm bg-black text-white px-3 py-1 md:px-4 md:py-1 rounded-md flex items-center gap-1 shadow-sm">
