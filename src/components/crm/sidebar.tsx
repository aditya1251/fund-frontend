...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {isMobile && (
        <div
          className={`fixed inset-0 bg-black transition-opacity duration-300 ease-in-out z-[999] ${
      ...
      <aside
        className={`flex flex-col bg-white h-full z-[1000] transition-all duration-300 ease-in-out
            ...
            isMobile
              ? open
                ? "fixed translate-x-0 w-64 shadow-2xl"
                : "fixed -translate-x-full w-0 opacity-0"
              : open
              ? "w-64 shadow-md"
              : "w-20 shadow-sm"
          }
            ...
            <Link href="/crm" className="flex items-center">
              <Image
                ...
                className={`transition-all duration-300 ${
                  !open && !isMobile ? "w-0 h-0 opacity-0" : "h-10 opacity-100"
                }`}
                quality={100}
                placeholder="blur"
            ...
            <div
              ...
              <span
                className={`transition-opacity duration-300 ${
                  !open && !isMobile ? "opacity-0 w-0 hidden" : "opacity-100"
                }`}>
                Log Out
              </span>
            </div>
