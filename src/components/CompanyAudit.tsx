...
export default function CompanyAuditLanding() {
  ...
  const serviceSteps = [
    {
      ...
      description:
        "Conduct a professional and thorough check of your company's books and financial records.",
    },
    {
      icon: <CheckCircle className="h-6 w-6" />,
      title: "Compliance Verification",
      description:
        "Ensure all your financial reports are accurate and compliant with legal requirements.",
    },
    {
      icon: <Upload className="h-6 w-6" />,
      title: "Report Filing",
      description:
        "Prepare and file the official audit report with the ROC on time.",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Clear Explanation",
      description:
        "Explain our findings to you in simple terms so you can make informed decisions.",
    },
  ];
  ...
  const auditProcess = [
    ...
    },
    {
      ...
      duration: "5-7 Days",
      description:
        "Analyze findings, review conclusions, and prepare draft report",
    },
    {
      step: "Report & Filing",
      duration: "3-5 Days",
  ...
  const auditTimeline = [
    {
      milestone: "Financial Year End",
      deadline: "31st March",
      action: "Close books of accounts",
    },
    {
      milestone: "Auditor Appointment",
      deadline: "Within 30 days",
      action: "Appoint statutory auditor",
    },
    {
      milestone: "Annual General Meeting",
      deadline: "Within 6 months",
      action: "Approve financial statements",
    },
    {
      milestone: "Audit Report Filing",
      deadline: "Within 30 days of AGM",
      action: "File audit report with ROC",
    },
  ];
    ...
    <div className="min-h-screen bg-[#FFFFFF]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-[#1E1E1E] max-w-4xl mx-auto mb-10 leading-relaxed">
              A company audit is an official check of your business's financial
              records by an independent expert called an auditor. The auditor
              verifies that all your financial reports are accurate, complete,
              and follow all legal rules.
            </p>
              ...
              <Card className="border-[#FFF0C3] shadow-lg">
                <CardContent className="p-8 mt-4">
                  ...
                  <p className="text-lg text-[#1E1E1E] leading-relaxed mb-6">
                    A company audit is an independent examination of financial
                    statements and records by a qualified auditor to ensure
                    accuracy, completeness, and compliance with applicable laws
                    and standards.
                  </p>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed">
                    This process provides stakeholders with confidence in the
                    financial information and helps identify areas for
                    improvement in financial controls and processes.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Different types of audits are required based on company size,
            turnover, and industry, each with specific requirements and
            timelines.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Company audits must comply with various professional standards and
            regulatory requirements to ensure quality and consistency.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Auditors provide different types of opinions based on their
            findings, each having different implications for stakeholders.
          </p>
            ...
            {auditOpinions.map((opinion, index) => (
              ...
              >
                <CardContent className="p-6 mt-4">
                  <div className="flex items-start gap-4">
                    <div
                      className={`p-2 rounded-lg ${opinion.color
                        .replace("text-", "text-")
                        .replace("bg-", "bg-")}`}
                    >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#1E1E1E] opacity-80 mb-2 text-sm">
                        {opinion.description}
                      </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Non-compliance with audit requirements can result in severe
            financial penalties and legal consequences for companies and
            directors.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Our systematic audit approach ensures thorough examination of
            financial records with timely delivery of audit reports.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Company audit ensures legal compliance, builds stakeholder trust,
            and provides valuable insights for business improvement and risk
            management.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Professional audit services provide comprehensive benefits that
            enhance business credibility and operational efficiency.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Our team of experienced auditors will make the audit process simple
            and efficient for you, ensuring complete compliance and valuable
            insights.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            All registered companies in India are required to get an audit done
            every financial year under the Companies Act 2013.
          </p>
