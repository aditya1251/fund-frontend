...
const CityIcon: React.FC = () => (
  ...
  >
    <path
      d="M4 15V13H6V15H4ZM11 15V13H13V15H11ZM20 15V13H22V15H20ZM4 19V17H6V19H4ZM11 19V17H13V19H11ZM20 19V17H22V19H20ZM1 11V9H3V11H1ZM8 11V9H10V11H8ZM15 11V9H17V11H15ZM1 15V13H3V15H1ZM8 15V13H10V15H8ZM15 15V13H17V15H15ZM1 19V17H3V19H1ZM8 19V17H10V19H8ZM15 19V17H17V19H15ZM22 5V3H24V5H22Z"
      fill="currentColor"
    />
    <path
      d="M19 11L19 1L17 1L17 5L15 5L15 1L13 1L13 5L11 5L11 1L9 1L9 5L7 5L7 1L5 1L5 11L19 11Z"
      fill="currentColor"
    />
  </svg>
);
...
const ConnectorIcon: React.FC = () => (
  ...
  >
    <path
      d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM15.5 14H14V16H15.5V14ZM14 8H15.5V10H14V8ZM8.5 14H10V16H8.5V14ZM10 8H8.5V10H10V8ZM14 11H15.5V13H14V11ZM8.5 11H10V13H8.5V11ZM11.25 11H12.75V13H11.25V11ZM11.25 8H12.75V10H11.25V8ZM11.25 14H12.75V16H11.25V14Z"
      fill="currentColor"
    />
  </svg>
);
...
const FinancialAdvisorIcon: React.FC = () => (
  ...
  >
    <path
      d="M12 1L3 5V11C3 16.55 6.84 21.75 12 23C17.16 21.75 21 16.55 21 11V5L12 1ZM12 10.99H17.97C17.43 15.58 14.28 19.46 10 20.77C5.72 19.46 2.57 15.58 2.03 10.99H12ZM12 4.14L19.07 7.21L12 10.28L4.93 7.21L12 4.14Z"
      fill="currentColor"
    />
  </svg>
);
