...
export default function CompanyRegistrationLanding() {
  const whyCompanyRegistrationCrucial = [
    ...
    },
    {
      ...
      description:
        "The company can own property, have a bank account, and enter into contracts in its own name.",
  ...
  const serviceSteps = [
    {
      ...
      description:
        "Helping you choose the right type of company for your business needs and goals.",
    },
    {
      icon: <FileText className="h-6 w-6" />,
      title: "Legal Documentation",
      description:
        "Handling all the complex legal paperwork and government filings required for registration.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Providing comprehensive guidance on what to do after the company is successfully registered.",
    },
  ];
  ...
  const registrationProcess = [
    ...
    {
      step: "Government Filing",
      duration: "3-5 Days",
      description: "File with ROC and get approvals",
    },
    {
  ...
  const requiredDocuments = [
    ...
    },
    {
      ...
      description: "Recent photographs of directors",
    },
  ];
    ...
    <div className="min-h-screen bg-[#FFFFFF]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-[#1E1E1E] max-w-4xl mx-auto mb-10 leading-relaxed">
              Company registration is the official process of starting your
              business and making it a legal entity. We make company
              registration simple and quick, giving your business its own
              identity separate from you as the owner.
            </p>
              ...
              <Card className="border-[#FFF0C3] shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-lg text-[#1E1E1E] leading-relaxed mb-6">
                    Company registration is the official process of starting
                    your business and making it a legal entity with its own
                    identity, separate from you as the owner.
                  </p>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed">
                    This could be a Private Limited Company, One Person Company,
                    or LLP, each offering different benefits for business growth
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            We help you choose the right type of company structure based on your
            business needs, growth plans, and operational requirements.
          </p>
                ...
                <CardContent className="p-8">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      ...
                      <Badge className="bg-[#1E1E1E] text-[#FFFFFF] mb-4">
                        {type.minDirectors}
                      </Badge>
                    </div>
                  </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Our streamlined process ensures your company registration is
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Company registration provides legal protection, business
            credibility, and growth opportunities that are essential for
            long-term success.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Registered companies enjoy numerous advantages that help accelerate
            business growth and provide legal security.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            We make company registration simple and quick, handling all complex
            legal processes for you.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Entrepreneurs who want to start a new business, protect their
            personal assets, and grow their company with a professional and
            legal structure.
          </p>
