...
export default function GSTServicesLanding() {
  const whyGSTCrucial = [
    ...
    },
    {
      ...
      description: "Banks often ask for your GST returns when you apply for a business loan.",
  ...
  const serviceSteps = [
    {
      ...
      description: "Helping you get your GST registration quickly and without any hassle.",
    },
    {
      icon: <FileText className="h-6 w-6" />,
      title: "Return Filing",
      description: "Preparing and filing all your monthly or quarterly GST returns (like GSTR-1 and GSTR-3B).",
    },
    {
      icon: <IndianRupee className="h-6 w-6" />,
      title: "Input Tax Credit",
      description: "Guiding you on how to claim all your eligible Input Tax Credits to maximize your savings.",
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Notice Handling",
      description: "Handling all communication and notices from the GST department on your behalf.",
    },
  ]
  ...
  const stats = [
    { number: "25K+", label: "GST Registrations", icon: <UserCheck className="h-5 w-5" /> },
    { number: "₹100Cr+", label: "ITC Claimed", icon: <IndianRupee className="h-5 w-5" /> },
    { number: "99.9%", label: "Filing Accuracy", icon: <Target className="h-5 w-5" /> },
    { number: "24hrs", label: "Registration Time", icon: <Clock className="h-5 w-5" /> },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <section className="bg-gradient-to-br from-[#FFF0C3] via-[#FFFFFF] to-[#FFF0C3] py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#1E1E1E] mb-4">GST Services</h1>
            ...
            <p className="text-lg sm:text-xl text-[#1E1E1E] max-w-4xl mx-auto mb-10 leading-relaxed">
              GST stands for Goods and Services Tax. It's a single tax system on the supply of goods and services in
              India. We simplify the entire GST process for your business, from registration to returns and compliance.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-12 text-center">What is GST?</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <Card className="border-[#FFF0C3] shadow-lg">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-[#1E1E1E]">Unified Tax System</h3>
                  </div>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed mb-6">
                    GST is a single tax system on the supply of goods and services in India. It replaced multiple
                    indirect taxes and created a unified national market.
                  </p>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed">
                    Many businesses that have a certain turnover need to get a GST registration number and file regular
                    returns (reports) every month or quarter to stay compliant.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-[#1E1E1E] mb-4">GST Rate Structure</h3>
              {gstRates.map((rate, index) => (
                <Card key={index} className="border-[#FFF0C3] hover:border-[#F7C430] transition-colors">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <Badge className="bg-[#F7C430] text-[#1E1E1E] text-lg px-3 py-1">{rate.rate}</Badge>
                        <span className="text-[#1E1E1E] text-sm">{rate.items}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">GST Return Types</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Different types of GST returns need to be filed based on your business type and turnover. We handle all
            ...
            {gstReturns.map((returnType, index) => (
              <Card key={index} className="bg-[#FFFFFF] border-none shadow-lg text-center">
                <CardContent className="p-6">
                  ...
                  <Badge className="bg-[#1E1E1E] text-[#FFFFFF] mb-3">{returnType.title}</Badge>
                  <h3 className="font-semibold text-[#1E1E1E] mb-2">{returnType.description}</h3>
                  <p className="text-sm text-[#1E1E1E] opacity-80">{returnType.frequency}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">Why is GST Crucial?</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            GST compliance is essential for business growth, legal protection, and financial benefits. Here's why your
            business needs proper GST management.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">Key GST Benefits</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            GST offers numerous advantages for businesses, from tax savings to improved credibility and streamlined
            processes.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            We simplify the entire GST process for you. Our comprehensive services cover everything from registration to
            ongoing compliance.
          </p>
              ...
              <Card key={index} className="border-[#FFF0C3] shadow-lg">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-sm font-medium text-[#F7C430] mb-1">Service {index + 1}</div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Businesses with an annual turnover of more than ₹40 Lakhs (or ₹20 Lakhs for services in some states) or
            those involved in selling goods and services across different states.
          </p>
            ...
            {businessTypes.map((type, index) => (
              <Card key={index} className="bg-[#FFFFFF] border-none shadow-lg text-center">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold text-[#1E1E1E] text-lg mb-2">{type.title}</h3>
                  <p className="text-[#1E1E1E] text-sm mb-3 leading-relaxed">{type.description}</p>
                  <Badge className="bg-[#1E1E1E] text-[#FFFFFF] text-xs">{type.threshold}</Badge>
                </CardContent>
              </Card>
            ))}
          </div>
