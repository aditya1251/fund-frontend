...
export default function FSSAIRegistrationLanding() {
  ...
  const serviceSteps = [
    {
      ...
      description:
        "Help you figure out which type of FSSAI registration you need (Basic, State, or Central License).",
    },
    {
      icon: <FileText className="h-6 w-6" />,
      title: "Documentation & Application",
      description:
        "Handle all the paperwork and fill out the online application form correctly for you.",
    },
    {
      icon: <CheckCircle className="h-6 w-6" />,
      title: "Follow-up & Processing",
      description:
        "Follow up with the FSSAI department to make sure your license is issued without any delays.",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Compliance Guidance",
      description:
        "Guide you on the rules and regulations you need to follow after getting your license.",
    },
  ];
  ...
  const fssaiLicenseTypes = [
    ...
    },
    {
      ...
      description:
        "For businesses with annual turnover ₹12 lakhs to ₹20 crores",
      features: [
        "Restaurants & cafes",
        "Food manufacturers",
        "Distributors",
  ...
  const registrationProcess = [
    {
      ...
      duration: "1 Day",
      description: "Evaluate business type and turnover",
    },
    {
    ...
    },
    {
      ...
      duration: "1 Day",
      description: "Submit application on FSSAI portal",
    },
    {
  ...
  const safetyStandards = [
    {
      ...
      description: "Proper food handling and storage procedures",
    },
    {
      standard: "Quality Control",
      description: "Regular testing and quality assurance measures",
    },
    {
      standard: "Labeling Requirements",
      description: "Accurate product labeling and ingredient disclosure",
    },
    {
      standard: "Traceability Systems",
      description: "Food source tracking and recall procedures",
    },
  ];
  ...
  const penaltyRisks = [
    {
      ...
      penalty: "₹25,000 fine + closure",
    },
    {
      violation: "Selling unsafe food",
      penalty: "₹1 lakh fine + imprisonment",
    },
    { violation: "Misleading advertisements", penalty: "₹10 lakh fine" },
    {
      violation: "Non-compliance with standards",
      penalty: "₹5 lakh fine + license cancellation",
    },
  ];
    ...
    <div className="min-h-screen bg-[#FFFFFF]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-[#1E1E1E] max-w-4xl mx-auto mb-10 leading-relaxed">
              ...
              It's a license or registration that is legally required for any
              business that deals with food. This includes everything from a
              small home-based food business to a large restaurant, hotel, or
              food factory.
            </p>
              ...
              <Card className="border-[#FFF0C3] shadow-lg">
                <CardContent className="p-8 mt-4">
                  ...
                  <p className="text-lg text-[#1E1E1E] leading-relaxed mb-6">
                    ...
                    registration is a mandatory license for any business
                    involved in food manufacturing, processing, distribution, or
                    sale.
                  </p>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed">
                    This license ensures that your food business complies with
                    food safety standards and regulations, protecting both
                    consumers and your business from legal issues.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Choose the right FSSAI license based on your business size, annual
            turnover, and operational scope.
          </p>
              ...
              >
                <CardContent className="p-8 mt-4">
                  <div className="text-center mb-6">
                    ...
                    <Badge className="bg-[#1E1E1E] text-[#FFFFFF] mb-2 text-xs">
                      {license.type}
                    </Badge>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Operating without FSSAI license or violating food safety standards
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Our streamlined process ensures your FSSAI license is obtained
            quickly and efficiently with complete compliance.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            FSSAI registration is not just a legal requirement but essential for
            building customer trust and ensuring business sustainability in the
            food industry.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            FSSAI registration ensures compliance with comprehensive food safety
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            FSSAI registration provides comprehensive benefits that enhance food
            business credibility and market access.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            We make FSSAI registration simple and quick, handling all complex
            processes for seamless license approval.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Anyone running a food business, including restaurants, cafes,
            hotels, food trucks, home-based bakers, online food sellers, and
            manufacturers.
          </p>
