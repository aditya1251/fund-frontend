...
export default function IECRegistrationLanding() {
  ...
  const serviceSteps = [
    {
      ...
      description: "Gather all required documents including PAN, bank certificate, and business registration proof.",
    },
    {
      icon: <Upload className="h-6 w-6" />,
      title: "Online Application",
      description: "File your IEC application online through the DGFT portal with accurate business details.",
    },
    {
      icon: <CheckCircle className="h-6 w-6" />,
      title: "Verification Process",
      description: "DGFT verifies your application and documents for compliance with trade regulations.",
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "IEC Certificate",
      description: "Receive your unique 10-digit IEC code and certificate for international trade operations.",
    },
  ]
  ...
  const stats = [
    { number: "25K+", label: "IEC Codes Issued", icon: <Globe className="h-5 w-5" /> },
    { number: "3 Days", label: "Processing Time", icon: <Clock className="h-5 w-5" /> },
    { number: "100%", label: "Success Rate", icon: <CheckCircle className="h-5 w-5" /> },
    { number: "Lifetime", label: "Validity Period", icon: <Award className="h-5 w-5" /> },
  ]

  const registrationProcess = [
    { step: "Document Preparation", duration: "1 Day", description: "Collect and verify required documents" },
    { step: "Online Application", duration: "1 Day", description: "Submit application on DGFT portal" },
    { step: "Payment & Verification", duration: "1 Day", description: "Fee payment and document verification" },
    { step: "IEC Issuance", duration: "1-2 Days", description: "Receive IEC certificate and code" },
  ]

  const requiredDocuments = [
    { document: "PAN Card", description: "Business PAN card copy", icon: <FileText className="h-4 w-4" /> },
    {
    ...
    { document: "Address Proof", description: "Business address proof document", icon: <MapPin className="h-4 w-4" /> },
  ]

  const tradeOpportunities = [
    { region: "Asia-Pacific", countries: "50+ Countries", potential: "High Growth Markets" },
    { region: "Europe", countries: "40+ Countries", potential: "Premium Markets" },
    { region: "Americas", countries: "35+ Countries", potential: "Large Consumer Base" },
    { region: "Africa & Middle East", countries: "75+ Countries", potential: "Emerging Markets" },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF]">
      ...
      <section className="bg-gradient-to-br from-[#FFF0C3] via-[#FFFFFF] to-[#FFF0C3] py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#1E1E1E] mb-4">IEC Registration</h1>
            ...
            <p className="text-lg sm:text-xl text-[#1E1E1E] max-w-4xl mx-auto mb-10 leading-relaxed">
              IEC stands for Importer-Exporter Code. It's a unique 10-digit code that is needed if you want to import or
              export goods and services from India to other countries. Issued by the Directorate General of Foreign
              Trade (DGFT), it's your official license for international business.
            </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-12 text-center">What is IEC Registration?</h2>
              ...
              <Card className="border-[#FFF0C3] shadow-lg">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-xl font-semibold text-[#1E1E1E]">International Trade License</h3>
                  </div>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed mb-6">
                    IEC (Importer-Exporter Code) is a unique 10-digit identification number required for any business
                    wanting to engage in international trade operations.
                  </p>
                  <p className="text-lg text-[#1E1E1E] leading-relaxed">
                    Issued by DGFT (Directorate General of Foreign Trade), this code is mandatory for importing or
                    exporting goods and services from India to other countries.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            IEC registration enables various types of international trade operations, from importing raw materials to
            exporting finished products and services.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">Global Trade Opportunities</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            With IEC registration, access international markets across all continents and tap into diverse business
            ...
            {tradeOpportunities.map((opportunity, index) => (
              <Card key={index} className="border-[#FFF0C3] hover:border-[#F7C430] transition-colors text-center">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold text-[#1E1E1E] text-lg mb-2">{opportunity.region}</h3>
                  <Badge className="bg-[#1E1E1E] text-[#FFFFFF] mb-3 text-xs">{opportunity.countries}</Badge>
                  <p className="text-[#1E1E1E] text-sm leading-relaxed">{opportunity.potential}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">IEC Registration Process</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Our streamlined process ensures your IEC registration is completed quickly and efficiently for immediate
            trade operations.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            IEC registration is not just a legal requirement but a gateway to unlimited global business opportunities
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1E1E1E] mb-8 text-center">Key Trade Benefits</h2>
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            IEC registration unlocks numerous advantages that help accelerate international business growth and provide
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            We make IEC registration simple and quick, handling all complex government processes for seamless
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF0C3]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#1E1E1E] text-center mb-12 max-w-3xl mx-auto">
            Any business planning to engage in international trade, whether importing raw materials, exporting products,
            or providing services globally.
          </p>
