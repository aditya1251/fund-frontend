      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center mb-16">
          <div className="bg-black rounded-full p-1 flex">
            <button className="px-6 py-2 rounded-full text-white font-medium">Standard</button>
            <button className="px-6 py-2 rounded-full bg-[#ffd439] text-black font-medium">Premium</button>
            <button className="px-6 py-2 rounded-full text-white font-medium">Professional</button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="bg-[#ffd439] border-4 border-black rounded-3xl overflow-hidden">
            <CardContent className="p-8">
              <h3 className="text-xl font-semibold text-black mb-6">Standard Plan</h3>
          ...
          <Card className="bg-[#ffd439] border-4 border-black rounded-3xl overflow-hidden">
            <CardContent className="p-8">
              <h3 className="text-xl font-semibold text-black mb-6">Premium Plan</h3>
          ...
          <Card className="bg-[#ffd439] border-4 border-black rounded-3xl overflow-hidden">
            <CardContent className="p-8">
              <h3 className="text-xl font-semibold text-black mb-6">Professional Plan</h3>
              <div className="text-3xl font-bold text-black mb-8">₹ 10999/-</div>
