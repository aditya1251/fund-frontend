...
const PlansPage = () => {
  ...
  const { data: plans = [], isLoading, error, refetch } = usePlansGetPlansQuery(undefined, {
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            <button
              ...
              className={`bg-black hover:bg-gray-800 text-white px-6 py-2 rounded-full font-medium transition-all duration-300 ease-in-out ${isRefreshing ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
          ...
          {plans
            ...
            .map((plan) => (
              ...
              >
                ...
                <div className="mb-6">
                  <span className="text-3xl font-bold text-black">₹{plan.amount}</span>
                  {plan.duration > 0 && <span className="text-gray-700">/{plan.duration}</span>}
                </div>
