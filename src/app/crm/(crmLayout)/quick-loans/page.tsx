...
export default function Page() {
  ...
  const { data: loansTemplates = [], isLoading: templatesLoading } = useGetLoanTemplatesByTypeQuery("quick");
        ...
        <div className="mt-6">
          <div className="py-4">
            <div className="flex justify-between items-center">
              <h4 className="text-lg font-semibold text-black">Quick Loan Leads</h4>
